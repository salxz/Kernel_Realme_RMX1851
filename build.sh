...
ANYKERNEL_REPO="https://github.com/Faisalxz/AnyKernel3.git"
...
# Telegram
CHATIDQ="-1001453677224"
CHATID="-1001453677224" # Group/channel chatid (use rose/userbot to get it)
TELEGRAM_TOKEN="1267244977:AAHb0pOBJKdqQ2ZBtJhrKbk7f8Zfd767lfY" #from botfather
...
makekernel() {
    ...
    export KBUILD_BUILD_HOST=Faisal_X
